...
export class SiegeGame {
  ...
  _spawnWave(waveNum) {
    ...
    switch (waveNum) {
      case 1: // Warm-up: basic melee and ranged
      ...
      case 2: // Siege formation: shields + ranged from all sides
        spawnWithEffect(spawnPoints[0].x, spawnPoints[0].y, 'shield_guard', 45, 5);
        spawnWithEffect(spawnPoints[0].x + 30, spawnPoints[0].y, 'crossbow_archer', 25, 9);
        spawnWithEffect(spawnPoints[1].x, spawnPoints[1].y, 'shield_guard', 45, 5);
        spawnWithEffect(spawnPoints[1].x - 30, spawnPoints[1].y, 'crossbow_archer', 25, 9);
        spawnWithEffect(spawnPoints[5].x, spawnPoints[5].y, 'knight', 35, 5);
        spawnWithEffect(spawnPoints[6].x, spawnPoints[6].y, 'knight', 35, 5);
        spawnWithEffect(spawnPoints[4].x, spawnPoints[4].y, 'archer', 22, 7);
        spawnWithEffect(spawnPoints[2].x, spawnPoints[2].y, 'berserker', 28, 6);
        break;

      case 3: // RAGNAROK: captain + war_golem + elite mix, max lava
    ...
    if (this.waveState === 'pause') {
      ...
      if (alive === 0) {
        ...
        if (this.currentWave >= this.totalWaves) {
          ...
          // Activate rune puzzle after wave 2  
          if (this.currentWave === 2 && this.runePuzzle && !this.runePuzzle.solved) {
          ...
          // Grant halberd after wave 2 is cleared
          if (this.currentWave === 2 && !this.player.hasWeapons.halberd) {
